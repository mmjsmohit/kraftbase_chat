...
import 'package:kraftbase_chat/theme/theme_type.dart';
...
class AppTheme {
  ...
  static init() {
    resetFont();
    Fx.changeTheme(theme);
  }

  static resetFont() {
    Fx.changeFontFamily(GoogleFonts.ibmPlexSans);
    Fx.changeDefaultFontWeight({
      100: FontWeight.w100,
      200: FontWeight.w200,
      300: FontWeight.w300,
      400: FontWeight.w300,
    ...
    Fx.changeDefaultTextFontWeight({
